...
urlpatterns = [
   ...
   # url(r'^User/', include('User.urls')),
    url(r'^User/', User.views.home_User, name='User_home'),
    url(r'^track/$', track.views.track, name='track'),
    url(r'^track1/ajax/', track.views.track_ajax, name='track_ajax'),
   # url(r'^User/', include('User.urls')),
   # url(r'^register/', include('register.urls')),
    url(r'^register_success/',stockapp.views.register_success,name='register_success'),
...
urlpatterns+=    [
url(r'^login/',django.contrib.auth.views.login,{'template_name':'login.html'},name='stockprediction_login'),
url(r'^logout/',django.contrib.auth.views.logout,{'next_page':'index'},name='stockprediction_logout')
]
